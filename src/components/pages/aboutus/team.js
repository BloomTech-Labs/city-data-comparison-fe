...
const team = [
  {
    ...
    about:
      "Anna Townsend is a full stack web Developer from Michigan.  Anna loves to stay creative through art and programming.  In her spare time she codes games and paints, even on walls.",
  ...
  },
  {
    ...
    about:
      "Luke Townsend is a data scientist in Kansas City, MO. He spent four years as an investment analyst at a university foundation. He’s interested in applying data science tools to improve the decision making process at businesses.",
  ...
  },
  {
    ...
    about:
      "Matthew Sessions is a Machine Learning Engineer in Seattle, Washington. Before becoming a full-time developer, Matthew was working abroad in Shenzhen, China as a cross-border e-commerce specialist. He believes that Data Science provides a roadmap that helps companies demystify complex business problems.",
  ...
  },
  {
    ...
    about:
      "Scott Maxwell is a data scientist & engineer in Gilbert, Arizona. He has a strong background in object oriented programming and software engineering. He is an individual driven by product delivery and software that provides solutions.",
  ...
  },
  {
    ...
    about:
      "Michael Harms is a software engineer based in Rochester, MN. He's also a published author and a carnivore. He is building tools to empower all humans with autonomy and usher in a new Golden Age through cost reduction.",
  ...
  },
  {
    ...
    about:
      "Muamer Kukic is a software engineer currently living in Las Vegas, Nevada. He aspires to be apart of the next big project that furthers education in growth of individuals and mental health. He is also a big basketball fan so feel free to contact his social media and talk trash about his favorite teams.",
  ...
  },
  {
    ...
    about:
      "A natural go-getter, Jeremy Rogel applies his knowledge of code and passion for creation by being the best fullstack web developer this side of the Mississippi! Applying his trade in Durham, NC, his passion to keep getting better shines in whatever he sets out to do.",
    portfolio: null,
  },
  {
    labs: 21,
    ...
    about:
      "Dariush Khansari tells stories through visual design and multimedia.",
  ...
  },
  {
    ...
    about:
      "Songa Mugenzi is a strategy-minded user experience designer passionate about designing applications for emerging technologies. His mission in life is to break through our self-imposed barriers to connecting with each other by spotlighting our shared human experience.",
    portfolio: null,
  },
  {
    labs: 21,
    ...
    about:
      'Jimmy "Zeb" Smith is a data scientist in Winchester, TN. Prior to starting Lambda, he obtained his bachelors of science at the University South. He majored in chemistry with a pre-engineering focus in math and physics. His interest lies in using emerging data science technologies for a better tomorrow.',
    portfolio: null,
  },
  {
    labs: 21,
    ...
    about:
      "Chris Shields applies data science to problem solving in Spokane, WA. Having received a liberal arts education in the desert, he is now driven to use software and mathematics to empower and improve",
    portfolio: null,
  },
  {
    labs: 21,
    ...
    about:
      "Eric Ramon is a Data Scientist in Las Vegas. He has over 10 years of teaching experience, has been coding as a hobby for almost 30 years, and even speaks Mandarin Chinese. He hopes to be able to use Data Science to help people understand complex problems, and find novel solutions.",
  ...
  },
  {
    ...
    about:
      "Anisha Sunkerneni is a Web Developer from California. She has a background in medicine and is interested in exploring the intersection of medicine and technology. Anisha enjoys cooking, curating playlists, playing boardgames and exploring new places.",
    portfolio: null,
  },
  {
    labs: 21,
    ...
    about:
      "Ryan Cooper is a Web Developer from Michigan. He loves learning, traveling, and meeting new people... and eating ramen, cannot forget about the ramen.",
    portfolio: null,
  },
  {
    labs: 21,
    ...
    about:
      "Regino Parragil is a Web Developer from Phoenix, AZ who wants to continue learning about the different libraries that are available to expand beyond basic web development. He is eager to see where the world of web development takes him.... or where he takes the world...",
    portfolio: null,
  },
  {
    labs: 21,
    ...
    about:
      "Thomas Rodriguez is a Software Engineer from San Jose, CA. He loves problem solving and learning new technologies. In his free time you can catch him watching California sports, playing videogames and playing guitar.",
    portfolio: null,
  },
  {
    labs: 21,
  ...
  },
  {
    ...
    about:
      "David Pok is a Full Stack Web Developer from Los Angeles.  He is a curious person who loves problem solving.",
    portfolio: null,
  },
  {
    labs: 23,
  ...
  },
  {
    ...
    about:
      "Steven Reiss is a Philly native with a passion for skiing, motorcycles, and problem solving.",
    portfolio: null,
  },
  {
    labs: 23,
  ...
  },
  {
    ...
    about:
      "Stephanie Miller is located in the PNW, she has a fondness for problem-solving, and a creative background to take it out of the box. She currently has 2 dogs, and works tirelessly to have more dogs in the future.",
    portfolio: null,
  },
];
