      ...
      <div className="pref-contents">
        <div className="header">
          <div className="head-top">
            <p>
              We are here for you. Personalize your results to view data that
              matters to you.
            </p>
          </div>
          <div className="head-middle">
            <p>
              Which of the following factors is the most important when moving
              to a new city?
            </p>
          </div>
          <div className="head-bottom">
            ...
            <p>
              As a default, all the categories are displayed.{" "}
              <span>Deselect</span> categories that you wish not to see or click
              the expand button <span>(=)</span> to view subcategories and make
              a change.
            </p>
          </div>
        </div>
        <div className="pref-tabs">
          ...
          <div className="tab">
            <ExpandIcon
              name="housing-expand"
              expand={housingExpand.status}
              toggle={toggleHousingExpand}
            />
            <div
              className={`housing-tab ${selectedHousing.status}`}
              onClick={toggleHousing}
            >
              <img
                className="pref-tabs-img"
                src={housingImg}
                alt="housing tab icon"
              />
              <p>Housing</p>
            </div>
            <img
              src={checkMark}
              className={`housing-tab-check ${selectedHousing.status}`}
              alt="check icon"
            />
          </div>
          ...
          <div className="tab">
            <ExpandIcon
              name="econ-expand"
              expand={econExpand.status}
              toggle={toggleEconExpand}
            />
            <div
              className={`econ-tab ${selectedEcon.status}`}
              onClick={toggleEcon}
            >
            ...
            <img
              src={checkMark}
              className={`econ-tab-check ${selectedEcon.status}`}
              alt="check icon"
            />
          </div>
          ...
          <div className="tab">
            <ExpandIcon
              name="social-expand"
              expand={socialExpand.status}
              toggle={toggleSocialExpand}
            />
            <div
              className={`social-tab ${selectedSocial.status}`}
            ...
            <img
              src={checkMark}
              className={`social-tab-check ${selectedSocial.status}`}
              alt="check icon"
            />
          </div>
