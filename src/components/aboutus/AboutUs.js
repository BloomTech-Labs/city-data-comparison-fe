    ...
    return(
            ...
            <div className="aboutUsContainer">
                <div className="aboutUsH1Div">
                    ...
                    <div className='aboutUsADiv'>
                        <a className='labslink' href='#labs19'>Labs 19</a>
                        <a className='labslink' href='#labs21'>Labs 21</a>
                    </div>
                </div>
            </div>
        </div>     
        ...
        <section className='aboutUsSection'>
            <div className="sectionContainer">
                ...
                <div className="aboutUsH2Div">
                    <h2 id='labs21' className="aboutUsH2">Labs 21 <span>Development Team</span></h2>
                </div>
